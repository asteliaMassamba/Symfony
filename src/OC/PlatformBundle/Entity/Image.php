...
class Image
{
    ...
    public function preUpload() {
        ...
        // son extension. Pour faire propre, on devrait renommer cet attribut en 
    ...
    public function upload() {
        ...
        $this->file->move(
                        ...
                        $this->id.".".$this->url // Le nim du fichier à créer, ici << id.extension >>
                     );
    }
    ...
    public function getUploadDir() {
        // On récupère le chemin relatif vers l'image pour un navigateur 
        // (relatif au répertoire /web donc)
        return "uploads/img";
    }
