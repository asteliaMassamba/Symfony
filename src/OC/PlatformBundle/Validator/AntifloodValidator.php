...
class AntifloodValidator extends ConstraintValidator {
    ...
    public function validate($value, Constraint $constraint) {
        // Pour récupérer l'objet Request tel qu'on le connaît, il 
        // faut utiliser getCurrentRequest du service request_stack
        $request = $this->requestStack->getCurrentRequest();
        
        // On récupère l'IP de celui qui poste
        $ip = $request->getClientIP();
        
        // On vérifie si cette IP a déjà posté une candidature il y 
        // a moins de  15 secondes
        $isFlood = $this->em
                        ->getRepository("OCPlatformBundle:Application")
                        ->isFlood($ip, 15);
        // Bien entendu, il faudrait écrire cette méthode isFlood, c'est 
        // pour l'exemple
